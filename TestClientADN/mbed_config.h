...
#define MBED_CONF_APP_ESP8266_RX                                              D2                                                                                               // set by application[NUCLEO_L476RG]
#define MBED_CONF_APP_ESP8266_TX                                              D8                                                                                               // set by application[NUCLEO_L476RG]
...
#define MBED_CONF_APP_WIFI_PASSWORD                                           "AAAFFFBBBC"                                                                                     // set by application
#define MBED_CONF_APP_WIFI_SSID                                               "KICS-IOT-DHCP"                                                                                  // set by application
...
#define MBED_CONF_TLS_SOCKET_DEBUG_LEVEL                                      1                                                                                                // set by library:tls-socket
...
// Macros
#define MBEDTLS_KEY_EXCHANGE_PSK_ENABLED                                                                                                                                       // defined by application
#define MBEDTLS_SHA1_C                                                                                                                                                         // defined by library:tls-socket
#define MBEDTLS_SSL_CIPHERSUITES                                              0x8C                                                                                             // defined by application
#define MBEDTLS_SSL_SESSION_TICKETS                                                                                                                                            // defined by application
